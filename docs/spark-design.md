...
- PostgreSQL 연결 실패 시 Spark가 자동 재시도
...
### 저장소 선택
- PostgreSQL 15
- 선택 이유: JSONB 지원 (590개 센서 압축 저장), SQL 집계 강력, Window Function 지원
...
- GIN 인덱스는 미적용: 현재 JSONB 검색 패턴 없어서 INSERT 성능 우선
